...
exports.events = exports.delEvent = exports.addEvent = exports.editEvent = exports.readEvent = exports.browseEvents = undefined;
...
var _promiseHandler = (0, _cooldux.promiseHandler)('browse', 'events'),
...
var _promiseHandler2 = (0, _cooldux.promiseHandler)('read', 'events'),
    readHandler = _promiseHandler2.readHandler;

var _promiseHandler3 = (0, _cooldux.promiseHandler)('edit', 'events'),
    addHandler = _promiseHandler3.addHandler;

var _promiseHandler4 = (0, _cooldux.promiseHandler)('add', 'events'),
    editHandler = _promiseHandler4.editHandler;

var _promiseHandler5 = (0, _cooldux.promiseHandler)('del', 'events'),
    delHandler = _promiseHandler5.delHandler;

var browseEvents = exports.browseEvents = function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _client2.default)('/events');
  ...
  return function browseEvents(_x) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _client2.default)('/events/' + id);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _client2.default)('/events/' + id, { method: 'POST', payload: payload });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return (0, _client2.default)('/events', { method: 'POST', payload: payload });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return (0, _client2.default)('/events/' + id, { method: 'DELETE ' });
